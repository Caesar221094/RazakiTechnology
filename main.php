...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Admin Panel | PT Razaki Tech</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="description" content="Web Company Profile PT Razaki Technology">
    <meta name="keywords" content="Caesar Rizki Octaviano" />
  ...
  <body class="skin-blue fixed">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="index2.html" class="logo"><b>Razaki</b> Technology</a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; 2021 - <a href="https://www.instagram.com/caesaroktaviano/" target="https://www.instagram.com/caesaroktaviano/">Caesar Rizki Octaviano</a>.</strong>
      </footer>
    </div><!-- ./wrapper -->
